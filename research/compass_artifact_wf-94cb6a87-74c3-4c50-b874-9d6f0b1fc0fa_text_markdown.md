...
- Cyprus holds parliamentary elections on **Sunday, 24 May 2026** to elect **56 of the 80 constitutionally established seats** in the House of Representatives. The other 24 seats are reserved for Turkish Cypriots and have remained vacant since 1963/64.
- The system is **open-list proportional representation across six districts**, using a three-phase seat allocation: a district-level Hare quota, then a national-level "reinforced PR" stage with a **3.6 % threshold** (raised from 1.8 % in 2015), and a third remainder stage with a **7.2 % threshold**.
- Polling on the eve of the election points to a **highly fragmented seven-party parliament**: DISY and AKEL roughly tied at 18–22 %, ELAM consolidating third place on ~10–15 %, and three new parties (ALMA, Direct Democracy Cyprus / "Fidias' party", Volt) likely to enter, while EDEK, DIPA and the Ecologists hover around or below the threshold.
...
A 2025 redistribution law (passed October 2025) transferred **one seat from Nicosia to Paphos** based on updated registered-voter counts. The 56-seat allocation for 24 May 2026 is:

| District | Seats 2021 | Seats 2026 | Registered voters (2026) | Ballot colour | Preference crosses |
|---|---|---|---|---|---|
| Nicosia (Λευκωσία) | 20 | **19** | 198,376 | White | **5** |
| Limassol (Λεμεσός) | 12 | 12 | 117,052 | Yellow | 3 |
| Famagusta (Αμμόχωστος)* | 11 | 11 | 116,345 | Blue | 3 |
...
## 1.3 Voter eligibility and the vote act

- Right to vote: Citizens of the Republic of Cyprus aged **18+**, with usual residence in Cyprus for the **last six months**.
- **Voting by proxy is not allowed.**
- **Compulsory voting** was *de jure* part of the Cypriot electoral code for decades but the mandatory-voting provisions were **abolished by amendments in 2017**. (ODIHR 2021 NAM report: "The 2017 changes abolished provisions for mandatory voting".) Turnout has nevertheless remained historically high (65.7 % in 2021, the lowest in the Republic's history at that point).
- ID: Voters must present an **electoral booklet or national ID card**. (A 2025 reform that lowered the voting age to 17, allowed driving licences as ID and introduced automatic registration **will only enter into force on 1 July 2027**, so it does not apply on 24 May 2026.)
- **Polling stations abroad** open in Athens, Thessaloniki, Patras, London, Manchester and Brussels, plus any city where at least 30 voters per district register.
- Polling stations open **07:00–18:00** (one-hour break at noon). Results are expected to be announced around **02:00 Monday 25 May**; swearing-in is at the **Nicosia Municipal Theatre at noon on 25 May**.

## 1.4 Ballot design and the act of voting

- Ballots are **colour-coded per district** (see table above) to facilitate sorting.
- In Nicosia, where 19 seats and 19 party lists are contested, the white ballot extends over **two folded sheets**. Larnaca alone uses a single-sided ballot.
- Each list (party, coalition or independent candidate) has a column with the **party emblem**, the **party leader's name** at the top, and candidates listed in **alphabetical order of surname** beneath.
- At the bottom of every column is a **box for the party vote**, marked with **"X", "+" or "✔"**. **Any other mark invalidates the ballot.**
- Beside each candidate's name is a small box. A voter may mark up to the **number of preference crosses permitted in their district** (Nicosia 5 / Limassol 3 / Famagusta 3 / Larnaca 2 / Paphos 2 / Kyrenia 1).
- **Preference crosses are optional.** A voter who marks only the party box casts a valid party vote.
...
After counting closes, candidates on each list are **re-ordered by the number of personal preference crosses received** (party leader/coalition head always ranked first). The number of seats won by the list in the district is then awarded to the **top-ranked candidates** in that re-ordered list.

## 1.6 Seat allocation: the three-phase algorithm
...
1. Compute the **electoral quota (μέτρο)**: `quota = floor(valid votes ÷ district seats)` (decimals dropped).
...
- **Single party:** must have ≥ **3.6 %** of the nationwide valid vote.
- **Two-party coalition:** ≥ **10 %**.
- **Coalition of three or more parties:** ≥ **20 %**.

Procedure (per Wikipedia/OSCE/Cyprus electoral-law summary):
...
### Re-assigning second/third-distribution seats to districts
...
International IDEA / ODIHR: **"In 2015, the threshold for political parties to participate in the second stage of mandate allocation was increased from 1.8 to 3.6 per cent of valid votes obtained nationwide."** The reform was intended to limit fragmentation but, as the *Southeast European and Black Sea Studies* journal observes, **"did not avert a highly fragmented parliament"**.

## 1.7 Worked numerical example, using actual 2021 district data

The 2021 election (30 May 2021) provides a complete worked example. Cyprus-wide: **357,712 valid votes, 65.72 % turnout**.
...
District quota: `122,347 ÷ 20 = 6,117` (integer part).

| Party | District votes | First-dist. seats (votes ÷ 6,117) | Unused votes |
|---|---|---|---|
| DISY | 31,163 | 5 | 31,163 − 30,585 = 578 |
| AKEL | 25,770 | 4 | 25,770 − 24,468 = 1,302 |
| DIKO | 13,449 | 2 | 13,449 − 12,234 = 1,215 |
| EDEK | 9,061 | 1 | 9,061 − 6,117 = 2,944 |
| Ecologists | 8,386 | 1 | 8,386 − 6,117 = 2,269 |
| DIPA | 8,232 | 1 | 8,232 − 6,117 = 2,115 |
| ELAM | 7,486 | 1 | 7,486 − 6,117 = 1,369 |

**First-distribution total: 15 seats. Remaining 5 Nicosia seats** (20 − 15) are filled from the national second/third allocation. Final Nicosia outcome in 2021 (per Ministry of Interior, summarised by StockWatch): DISY 5, AKEL 6, DIKO 3, EDEK 1, Ecologists 2, DIPA 2, ELAM 1.

Note how AKEL's relatively large Nicosia unused vote (1,302) earned the party an extra Nicosia seat in the national redistribution, even though its first-distribution count was only 4.

### Kyrenia 2021 (3 seats, 17,556 valid votes)

District quota: `17,556 ÷ 3 = 5,852`. **No party reached the quota.**

| Party | District votes |
|---|---|
| AKEL | 4,296 |
| DISY | 4,266 |
| DIKO | 2,634 |
...
**All 3 Kyrenia seats are allocated in the second/third distribution.** Final 2021 Kyrenia result: DISY 2, AKEL 1.

### Paphos 2021 (4 seats, 32,298 valid votes)

District quota: `32,298 ÷ 4 = 8,074`. Only DISY (9,650) cleared the quota → 1 seat at the first distribution (unused = 1,576). The remaining 3 Paphos seats went via national pool to AKEL, DIKO and EDEK (1 each), even though none of those parties had reached quota in Paphos itself.

This illustrates a defining feature of the Cypriot system: **a party that crosses the 3.6 % national threshold can win district seats it did not "earn" at the district level**, while a party below 3.6 % nationally is locked out even if it polls strongly somewhere.
...
- **Religious-group representatives:** Vartkes Mahdessian (Armenian) and Antonella Mantovani (Latin) declared elected unopposed. Two Maronite candidates contest (Petros Nacouzi vs incumbent Marios Mavrides).

## 2.2 Parties contesting on 24 May 2026
...
14. **Patriotic Front "Lakedaimonioi" (Spartans).** Tiny far-right list. Leader: Marianna Athanasiou.
15. **"Sikou Pano!" ("Get Up!" in Cypriot Greek).** Founded January 2026; anti-establishment list led by Christoforos Tornaritis (former Olympiakos Nicosia chairman); also includes his wife Ramona Filip.
16. **Far-Left Resistance – Communism.** Led by Celestina De Petro. Marginal.
17. **Popular Struggle for Freedom.** Led by Apostolos Apostolou.
18. **Agronomos – Agricultural Workers' Party.** Led by Andreas Christofi.
19. **Green Party of Cyprus.** New, separate from KOSP.

Plus **9 independents**.

### High-profile retirements / switches

- Not standing again: **Averof Neofytou (DISY former leader & 2023 presidential candidate)**, Efthymios Diplaros, Harris Georgiades, Nicos Tornaritis, Onouphrios Koullas, Kyriacos Chatzigiannis (all DISY); Andros Kyprianou (AKEL former GS), Andros Kafkalias, Kostas Kosta, Christos Christofias (all AKEL); Pavlos Mylonas, Christos Orfanides (DIKO); Ilias Myrianthous, Marinos Sizopoulos (EDEK); Kostis Efstathiou (independent, ex-EDEK); Charalambos Theopemptou (KOSP); Marios Garoyian (DIPA leader, stepping back). **Irene Charalambidou (AKEL Nicosia)** is ineligible due to AKEL's term limits.
- Switched parties: Three sitting MPs switched lists for 2026, including **Alexandra Attalides (KOSP → Volt)** and **Michalis Giakoumis (DIPA → DIKO)**.
- Notable newcomers: actor **Christoforos Christoforou** (DISY); Alpha TV anchor **Constantinos Constantinou** (AKEL); TV producer **Melanie Steliou** (AKEL); theatre star **Elena Papadopoulou** (DIKO); **Sophia Vassiliou** (Volt, daughter of late President George Vassiliou); **Makarios Drousiotis** (Volt, investigative journalist).

## 2.3 2021 baseline (comparison anchor)

| Party | 2021 votes | 2021 % | 2021 seats | District seats |
|---|---|---|---|---|
| DISY | 99,328 | 27.77 | 17 | Nic 5, Lim 3, Fam 4, Lar 2, Pap 1, Kyr 2 |
| AKEL | 79,913 | 22.34 | 15 | Nic 6, Lim 3, Fam 3, Lar 1, Pap 1, Kyr 1 |
| DIKO | 40,395 | 11.29 | 9 | Nic 3, Lim 2, Fam 2, Lar 1, Pap 1 |
| ELAM | 24,255 | 6.78 | 4 | Nic 1, Lim 1, Fam 1, Lar 1 |
...
## 2.4 Complete 2026 polling table

All publicly released polls for the 2026 parliamentary election, in reverse chronological order. **Note on the legal blackout:** under Cypriot law, **publication of poll results is forbidden on election eve (Saturday 23 May) and on polling day itself**. The last legal publication window closed on Friday 15 May / Saturday 16 May 2026.

Vote-share columns are first-preference intentions (raw, not redistributed) unless noted. "ADK" = Direct Democracy Cyprus (Fidias). Dashes indicate the party was either not listed or polled <0.1 %.
...
Three trends:
1. **Disy reconsolidates its narrow lead** over AKEL in most pollsters (Explorer 19.7 vs 18.8; Prime 18.0 vs 17.6; RAI 18.2 vs 15.2), though MRC Cypronetwork and CYMAR show ties.
...
| Source | DISY | AKEL | ELAM | ALMA | ADK | DIKO | Volt | EDEK/DIPA/KOSP |
|---|---|---|---|---|---|---|---|---|
| Alpha / RAI seat projection (May) | 15 | 13 | 9 | 6 | 4 | 6 | 3 | 0 |
| SIGMA seat projection (May) | 13–15 | 12–14 | 7–9 | 6–7 | 6–7 | 5–6 | 2–4 | 0–2 each |
| Cypronetwork / RIK (March) | 15 | 15 | 10 | 6 | 4 | 6 | 0 | 0 |
| PolitPro trend (17 May 2026) | 14 | 13 | 9 | 6 | 5 | 6 | 3 | 0 |

**No party comes close to the 29-seat majority threshold.** Cyprus is heading for its most fragmented parliament since 1985, with 7 parties likely to enter and DISY+AKEL combined likely to fall below 50 % of seats for the first time.

## 2.7 Key issues driving the vote (CyBC issue poll, May 2026)

- **Economy / cost of living:** 35 % cite as the most important issue
- **Cyprus problem:** 25 %
- **Corruption:** 16 %
- **Inflation/price rises (specific):** 11 %
- **Migration:** 8 %

70 % "very or fairly interested" in the campaign; **trust in political parties at just 18 %**.

73 % of voters believe the country is heading in the wrong direction (Prime/SIGMA, Sep 2025); 76 % dissatisfied with President Christodoulides (also Sep 2025).
...
- **Βουλή των Αντιπροσώπων (Voulí ton Antiprosópon)** – House of Representatives.
- **Εκλογικό Μέτρο (Eklogikó Métro)** – Electoral quota; the divisor used in the first distribution (= valid votes ÷ seats, integer part). Equivalent to the **Hare quota** with truncation.
- **Πρώτη Κατανομή (Próti Katanomí)** – First distribution (at district level).
...
- **Συσπείρωση (Syspírosi)** – Voter consolidation / loyalty (% of party's previous voters who stay with the party).
- **Αναγωγή στα έγκυρα (Anagogí sta Énkyra)** – Redistribution to valid votes (poll convention of excluding undecided/blank from the percentage base).
- **Συμμετοχή (Symmetochí)** – Turnout.
- **Διάλυση της Βουλής (Diályssi tis Voulís)** – Dissolution of Parliament.

---

# Recommendations (for the website-building agent)

1. **Lead with a "seven-party fragmented parliament" framing** on the landing page rather than the traditional "DISY vs AKEL" binary; the polling consensus is that neither big party will reach 25 % and at least three new entrants will sit in parliament.
...
7. **Trigger thresholds that should reset the editorial line on election night:**
 ...
 - **ELAM ≥10 seats** → "far-right consolidates as the new third force".
 - **Either ALMA or ADK ≥7 seats** → "anti-establishment breakthrough".
 - **Turnout <60 %** → "lowest turnout in Republic's history".
 - **EDEK or KOSP misses threshold** → "historic exit of an established party".

---

# Caveats

- **Poll quality varies wildly** across pollsters. PolitPro rates MRC Cypronetwork at 67/100; RAI Consultants is unrated. Sample sizes range from 800 (Stratego-IMR) to 2,460 (Unitrustmedia online). Where margins of error were not published they are marked n/a; reported MoE figures are typically ±2.7 – ±3.0 percentage points.
- **The Vouli TV / Unitrustmedia online panel** (June 2025) showing ALMA at 20 % is widely treated by Cypriot analysts as an outlier reflecting over-sampling of disaffected voters; included for completeness only.
...
## Source URL master list (for linking)

**Official Cyprus government**
- Central Elections Service: https://www.gov.cy/moi-elections/en/documents/parliamentary-elections-2026/how-to-vote/
